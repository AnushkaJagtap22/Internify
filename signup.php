...
<body>
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">
          <img src="logo.jpg" alt="Logo" style="display: inline-block; height: 30px; margin-right: 5px;">
          Internify
        </a>
    </div>
...
<div>
 ...
 <div class="radio" >
  <label>
    <input type="radio" name="type" id="usertype" value=0>
    Student
  </label>
</div>
<div class="radio">
  <label>
    <input type="radio" name="type" id="usertype2" value=1>
    Employer
  </label>
</div><br>
